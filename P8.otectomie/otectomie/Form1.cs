...
namespace otectomie
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Click(object sender, EventArgs e)
        {
            ...
            g.DrawString((n + 1).ToString(), new Font(FontFamily.GenericSansSerif, 10), new SolidBrush(Color.Purple), p[n].X + raza, p[n].Y - raza);
            if (!poligon_inchis)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (n < 3)
                return;
            if (n == 3)
                label1.Text = Convert.ToString(Aria(p[0], p[1], p[2]));
